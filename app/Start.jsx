    ...
    >
      <View>
        ...
        <View>
          ...
          <View className="flex justify-center flex-row mt-10">
            ...
            <TouchableOpacity className="bg-green-500 rounded-md  mx-2" onPress={()=>{router.push('Result')}}>
      ...
      <Modal
        ...
        >
          ...
          >
            <View
              style={{ backgroundColor: "#fff", width: "90%", padding: 20 }}
            >
              <Text className="text-center text-xl font-extrabold  ">
                The author name end with fullstop . The place name will ends
                with a colon : The edition name will ends with fullstop 2nd ed.
              </Text>
